"""
Django settings for feedtestapp_40468 project.
...
ROOT_URLCONF = 'feedtestapp_40468.urls'
...
WSGI_APPLICATION = 'feedtestapp_40468.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "feedtestapp_40468 API",
    "DESCRIPTION": "API documentation for feedtestapp_40468 App",
    "VERSION": "v1",
}
