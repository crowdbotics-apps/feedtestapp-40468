...
export const api_v1_post_list = createAsyncThunk(
  "posts/api_v1_post_list",
  async payload => {
    const response = await apiService.api_v1_post_list(payload)
    return response.data
  }
)
export const api_v1_post_create = createAsyncThunk(
  "posts/api_v1_post_create",
  async payload => {
    const response = await apiService.api_v1_post_create(payload)
    return response.data
  }
)
export const api_v1_post_retrieve = createAsyncThunk(
  "posts/api_v1_post_retrieve",
  async payload => {
    const response = await apiService.api_v1_post_retrieve(payload)
    return response.data
  }
)
export const api_v1_post_update = createAsyncThunk(
  "posts/api_v1_post_update",
  async payload => {
    const response = await apiService.api_v1_post_update(payload)
    return response.data
  }
)
export const api_v1_post_partial_update = createAsyncThunk(
  "posts/api_v1_post_partial_update",
  async payload => {
    const response = await apiService.api_v1_post_partial_update(payload)
    return response.data
  }
)
export const api_v1_post_destroy = createAsyncThunk(
  "posts/api_v1_post_destroy",
  async payload => {
